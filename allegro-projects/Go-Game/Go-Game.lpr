;; -*- lisp-version: "10.0 [Linux (x86)] (Mar 10, 2017 10:58)"; -*-

(in-package :cg-user)

(define-project :name :|Go-Game|
  :modules (list (make-instance 'module :name "alpha-beta-go.lisp")
                 (make-instance 'module :name "Go-Game.lisp"))
  :projects nil
  :libraries nil
  :editable-files nil
